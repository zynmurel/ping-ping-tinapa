...
export default function Home() {
  ...
  const menuItems = [
    { title: "Guide", key: "guide", children: <GuideCard /> },
    {
      title: "Products",
      key: "products",
  ...
  return (
    <>
      ...
      <main className=" flex min-h-screen flex-col items-center overflow-hidden p-0">
        <div
          className={` absolute bottom-0 left-0 top-0 z-50 flex w-1/2 flex-col overflow-scroll bg-[#faebd0f0] p-2 transition-all duration-300 sm:hidden ${
